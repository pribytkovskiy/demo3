export const ONLINE_API_URL = process.env.NODE_ENV === 'production' ? 'http://10.172.0.2:8080/api' : 'http://10.172.0.2:8080/api';
export const OFFLINE_API_URL = 'http://10.172.0.2:8080/api';
